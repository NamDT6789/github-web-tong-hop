...
<div class="container">
    <div class="table-title">
        <div class="title-sub">
            <h2><b><a href ="/submission/index" class = "back-to-index">Submission </a></b></h2>
        </div>
        <div class="col-right">
            <div class="add-sub">
            ...
            <div class="user-title">
                <div href="" class="title">Chao: {!! isset($user_name) ? $user_name :'' !!}</div>
            </div>
        </div>
    </div>
    <div class="table-wrapper table-sub">
        <table class="table table-striped table-hover" id="submission-table">
            ...
            <?php $index = 0; ?>
            @foreach($getresultsearch as $item)
                <?php $index++;?>
                <tr>
                    <td>
